...
{
    public class DoublyLinkedList_Remove : TestDoublyLinkedList
    {
        [Fact]
        ...
        [InlineData(9)]
        [InlineData(10)]
        public void Remove_ListWithValuesFrom1To10_RemoveFirstValueBackEnumeratorReturnsLength(int length)
        {
            for (int i = 1; i <= length; i++)
            {
                _list.Add(i.ToString());
        ...
        [InlineData(9)]
        [InlineData(10)]
        public void Remove_ListWithValuesFrom1To10_RemoveLastValueBackEnumeratorReturnsLength(int length)
        {
            for (int i = 1; i <= length; i++)
            {
                _list.Add(i.ToString());
